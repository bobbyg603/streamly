...
@Component({
  selector: 'streamly-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<streamly-big-input-action></streamly-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<streamly-big-input-action [disabled]="true"></streamly-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<streamly-big-input-action fontSet="fas" fontIcon="trash"></streamly-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<streamly-big-input-action label="delete"></streamly-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<streamly-big-input-action (action)="actionHandler()"></streamly-big-input-action>';
    fixture = createHostComponent(template);
